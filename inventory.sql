...
insert  into `tblaccounts`(`accountid`,`user_id`,`username`,`account_password`,`first_name`,`last_name`,`middle_name`,`address`,`age`,`email_address`,`contact_number`,`account_type`,`is_blocked`) values (7,'001','darren','darren','darren','acuna','','Bulacan',23,'darren@gmail.com','09611917651','System Admin',0);
...
insert  into `tblinventory`(`inventory_id`,`product_id`,`product_name`,`color`,`categoryid`,`subcategoryid`,`sizesid`,`madefromid`,`cooperativeid`,`qty_available`,`reorder_threshold`,`storageid`,`cost_price`,`retail_price`,`unitid`,`created_at`,`current_stock`,`current_stock_date`,`new_stock`,`new_stock_date`,`total_stock`) values (6,'C-C-L-0006','Darrend','Blue',9,2,6,4,2,0,'',7,100,0,5,'2025-05-13 23:43:22',0,NULL,0,NULL,0),(7,'F-C-O-0007','Walis','Yellow',6,2,7,3,4,0,'',1,250,0,5,'2025-05-14 09:46:19',0,NULL,0,NULL,100),(8,'C-C-L-0008','Tambo','Red',9,7,6,8,4,20,'',5,299,0,7,'2025-05-14 13:15:22',0,NULL,0,NULL,0);
...
insert  into `tblsales`(`sales_id`,`order_id`,`created_at`,`processed_by`,`payment_method`,`price_pay`,`is_void`) values (1,'ORD-0001','2025-05-14 14:13:09',7,'GCash',0,0),(2,'ORD-0002','2025-05-14 14:13:54',7,'GCash',0,0),(3,'ORD-0003','2025-05-14 14:14:40',7,'GCash',0,0),(4,'ORD-0004','2025-05-14 16:13:02',7,'GCash',0,0);
...
insert  into `tblsales_details`(`id`,`sales_id`,`inventory_id`,`qty`,`puhunan`,`price`,`is_void`) values (1,1,0,0,0,0,0),(2,2,6,2,100,233,0),(3,2,8,2,299,500,0),(4,3,6,2,100,233,0),(5,3,8,1,299,500,0),(6,4,8,2,299,500,0);
