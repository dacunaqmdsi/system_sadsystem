...
insert  into `tblsales`(`sales_id`,`order_id`,`created_at`,`processed_by`,`payment_method`,`price_pay`,`is_void`) values (1,'ORD-0001','2025-05-14 14:13:09',7,'GCash',0,0),(2,'ORD-0002','2025-05-14 14:13:54',7,'GCash',0,0),(3,'ORD-0003','2025-05-14 14:14:40',7,'GCash',0,0),(4,'ORD-0004','2025-05-14 16:13:02',7,'GCash',0,0),(5,'ORD-0005','2025-05-14 16:28:01',7,'Cash',0,0),(6,'ORD-0006','2025-05-14 16:52:18',7,'Cash',0,0);
...
insert  into `tblsales_details`(`id`,`sales_id`,`inventory_id`,`qty`,`puhunan`,`price`,`is_void`) values (1,1,0,0,0,0,0),(2,2,6,2,100,233,0),(3,2,8,2,299,500,0),(4,3,6,2,100,233,0),(5,3,8,1,299,500,0),(6,4,8,2,299,500,0),(7,5,6,2,100,233,0),(8,5,8,3,299,500,0),(9,6,6,4,100,233,0),(10,6,8,5,299,500,0);
...
insert  into `tmp_order7`(`id`,`inventory_id`,`qty`,`puhunan`,`price`,`order_id`) values (1,6,2,100,233,'ORD-0007'),(2,8,3,299,500,'ORD-0007');
