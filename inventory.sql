...
insert  into `tblcategory`(`categoryid`,`category`,`is_archived`) values (1,'darren','Yes'),(2,'Sample hehe','No'),(3,'Kelly','No'),(4,'Carpentry Tools','No'),(5,'Blacksmith Tools','Yes'),(6,'Farming Tools','No'),(7,'Masonry Tools','No'),(8,'Shoemaking Tools','No'),(9,'Clockmaking Tools','No');
...
insert  into `tblsales`(`sales_id`,`order_id`,`created_at`,`processed_by`,`payment_method`,`price_pay`,`is_void`) values (1,'ORD-0001','2025-05-14 14:13:09',7,'GCash',0,0),(2,'ORD-0002','2025-05-14 14:13:54',7,'GCash',0,0),(3,'ORD-0003','2025-05-14 14:14:40',7,'GCash',0,0);
...
insert  into `tblsales_details`(`id`,`sales_id`,`inventory_id`,`qty`,`puhunan`,`price`,`is_void`) values (1,1,0,0,0,0,0),(2,2,6,2,100,233,0),(3,2,8,2,299,500,0),(4,3,6,2,100,233,0),(5,3,8,1,299,500,0);
